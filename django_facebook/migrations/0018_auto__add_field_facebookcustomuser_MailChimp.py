...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookCustomUser.MailChimp'
        db.add_column(u'django_facebook_facebookcustomuser', 'MailChimp',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookCustomUser.MailChimp'
        db.delete_column(u'django_facebook_facebookcustomuser', 'MailChimp')
    ...
    models = {
        ...
        u'django_facebook.facebookcustomuser': {
            'MailChimp': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
