...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'emailconfirmation_emailaddress', (
        ...
        db.send_create_signal(u'emailconfirmation', ['EmailAddress'])

        # Adding unique constraint on 'EmailAddress', fields ['user', 'email']
        db.create_unique(u'emailconfirmation_emailaddress', ['user_id', 'email'])

        # Adding model 'EmailConfirmation'
        db.create_table(u'emailconfirmation_emailconfirmation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'emailconfirmation', ['EmailConfirmation'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailAddress', fields ['user', 'email']
        db.delete_unique(u'emailconfirmation_emailaddress', ['user_id', 'email'])

        # Deleting model 'EmailAddress'
        db.delete_table(u'emailconfirmation_emailaddress')

        # Deleting model 'EmailConfirmation'
        db.delete_table(u'emailconfirmation_emailconfirmation')
    ...
    models = {
        ...
        u'emailconfirmation.emailaddress': {
        ...
        u'emailconfirmation.emailconfirmation': {
            'Meta': {'object_name': 'EmailConfirmation'},
            'confirmation_key': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'email_address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['emailconfirmation.EmailAddress']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
